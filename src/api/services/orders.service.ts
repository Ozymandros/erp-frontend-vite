...
class OrdersService {
  ...
  async createOrderWithReservation(data: CreateOrderWithReservationDto): Promise<OrderDto> {
    return this.apiClient.post<OrderDto>("/orders/api/orders/with-reservation", data)
  }
